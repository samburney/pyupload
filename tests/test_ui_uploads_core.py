"""Tests for upload and download lifecycle endpoints.

- GET /uploads — display upload form page
- POST /uploads — process file upload form submissions
- GET /get/{id}/{filename} and GET /download/{id}/{filename} — file serving
- Integration between UI endpoints and the upload handler
- Error handling for file serving (missing files, auth failures, image processing errors)
"""
