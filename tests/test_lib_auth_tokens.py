"""Tests for JWT token lifecycle in app/lib/auth.py.

- JWT access token creation, expiration, and algorithm correctness
- Refresh token creation, storage, validation, and revocation
- Multi-user token isolation
- Token cookie configuration and security flags
"""
