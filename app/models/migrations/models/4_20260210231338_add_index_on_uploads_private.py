...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE `uploads` ADD INDEX `idx_uploads_private_7ab102` (`private`);"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE `uploads` DROP INDEX `idx_uploads_private_7ab102`;"""
...
MODELS_STATE = (
    ...
    "FpLxeh6EoSvEdwI7vxyn1rI4Xf996eNOeltSm657OrACymURexTCqhQcBU9baq3q69envC"
    "Y+XJeDQtKt+OpQDDvyuye1o4/PMl7YFZa1Z4ACkylh1JVtjvOS7KCoNIRiWFG7YvHRckhe"
    "8hdSrml2Iq7fTBanFkxatRAaIv3k6A3ZNykWdR6JmJPfknMogl0Xt+GUxMZQ/VLy+30dda"
    "/vKiX02x/R+7+qHV"
)
